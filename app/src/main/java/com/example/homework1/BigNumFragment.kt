...
class BigNumFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        textNum.text = number
        if (numInt % 2 == 0)
            view.findViewById<TextView>(R.id.textViewNum).setTextColor(ContextCompat.getColor(textNum.context, R.color.odd))
        else
            view.findViewById<TextView>(R.id.textViewNum).setTextColor(ContextCompat.getColor(textNum.context, R.color.even))
    }
